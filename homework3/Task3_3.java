//Написать описанные выше методы таким образом, чтобы они возвращали
//результат, а не выводили его
...
public class Task3_3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Разность введенных чисел равна: " + myFirstResult);
		...
		System.out.println("Сумма введенных чисел равна = " + mySecondResult);
